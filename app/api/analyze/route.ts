...
- **[Scoring Cap]** 화장실/개수대/샤워실 중 단 하나의 사진도 식별되지 않는다면, "검증 불가"로 간주하여 **위생 점수를 최대 60점으로 제한(Cap)**하세요.
   - 관리 상태 확인: 쓰레기가 없더라도 **'녹슨 기둥', '벗겨진 페인트', '정리되지 않은 잡풀'** 등 관리 소홀 흔적을 찾아 감점 요소에 반영하세요.
...
- Target 40: 생활감이 느껴지는 짐들이 보이나 위생적임.
- Target 60 (Cap): 화장실/샤워실/개수대 사진이 아예 없는 경우 (최대치).
- Target 20: 쓰레기, 곰팡이, 정돈 안 된 짐들이 한 장이라도 명확히 보임.
